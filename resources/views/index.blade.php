...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('client/css/templatemo-hexashop.css') }}">

    <link rel="stylesheet" href="{{ asset('client/css/owl-carousel.css') }}">

    <link rel="stylesheet" href="{{ asset('client/css/lightbox.css') }}">
    <!--
...
<body>
    ...
    <!-- jQuery -->
    <script src="{{ asset('client/js/jquery-2.1.0.min.js') }}"></script>
    ...
    <script src="{{ asset('client/js/imgfix.min.js') }}"></script>
